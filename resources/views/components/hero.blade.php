        ...
        <div class="{{ $image ? 'grid grid-cols-1 md:grid-cols-2 gap-10 items-center' : 'max-w-3xl' }}">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="https://wa.me/{{ \App\Models\SiteSetting::get('whatsapp_number', '593999000000') }}?text=Hola%2C%20quisiera%20agendar%20una%20cita"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="btn-secondary px-6 py-3"
                       data-track-event="whatsapp_click"
                       data-track-category="conversion"
                       data-track-label="WhatsApp Hero"
                       data-track-location="home_hero"
