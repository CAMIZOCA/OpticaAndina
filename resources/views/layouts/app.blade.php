...
<head>
    ...
    <x-seo-meta
        ...
        :og-locale="$seo['og_locale'] ?? 'es_EC'"
        :twitter-site="$seo['twitter_site'] ?? null"
        :twitter-creator="$seo['twitter_creator'] ?? null"
        :theme-color="$seo['theme_color'] ?? '#0f766e'"
        :canonical="$seo['canonical'] ?? null"
        :noindex="$seo['noindex'] ?? false"
        :robots="$seo['robots'] ?? (($seo['noindex'] ?? false) ? 'noindex, follow' : 'index, follow')"
