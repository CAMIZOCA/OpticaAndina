        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div>
                ...
                <div class="space-y-5">
                    ...
                    @if($address)
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    @if($phone)
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:{{ $phone }}" class="text-teal-600 hover:underline">{{ $phone }}</a>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($email)
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:{{ $email }}" class="text-teal-600 hover:underline">{{ $email }}</a>
                            </div>
                        </div>
                    @endif
                ...
                <div class="mt-8 rounded-xl overflow-hidden border border-gray-200 h-56 bg-gray-100 flex items-center justify-center">
                    <p class="text-gray-400 text-sm">Mapa – Tumbaco, Quito, Ecuador</p>
                </div>
            </div>
                ...
                <form action="{{ route('contacto.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                               value="{{ old('name') }}"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('name') border-red-400 @enderror"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email"
                               value="{{ old('email') }}"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('email') border-red-400 @enderror"
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="5"
                                  class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('message') border-red-400 @enderror"
                    ...
                    <button type="submit"
                            class="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 px-6 rounded-lg transition">
                        Enviar Mensaje
                    </button>
                </form>
            </div>
