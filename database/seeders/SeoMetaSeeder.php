...
class SeoMetaSeeder extends Seeder
{
    public function run(): void
    {
        $metas = [
            [
                'page_key'         => 'home',
                'title'            => 'Óptica Andina – Tumbaco, Quito, Ecuador',
