...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            // general
            ['key' => 'site_name',        'value' => 'Óptica Andina',                            'group' => 'general'],
            ...
            ['key' => 'email',            'value' => 'info@opticaandina.com',                     'group' => 'contact'],
            ...
            // seo
            ['key' => 'seo_title',        'value' => 'Óptica Andina – Tumbaco, Ecuador',        'group' => 'seo'],
            ...
            // stripe
            ['key' => 'stripe_enabled',    'value' => '0', 'group' => 'stripe'],
            ['key' => 'stripe_public_key', 'value' => '',  'group' => 'stripe'],
